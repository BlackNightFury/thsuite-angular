...
@Component({
    selector: 'app-discounts-by-product-type',
    templateUrl: './discounts-by-product-type.component.html',
})
export class DiscountsByProductTypeComponent implements OnInit{
    ...
    ngOnInit() {
        this.discountService.getReportData('product-type', this.dateRangeSource).subscribe((discountData) => {
