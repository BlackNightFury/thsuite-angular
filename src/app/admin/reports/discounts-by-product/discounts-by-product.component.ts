...
@Component({
    selector: 'app-discounts-by-product',
    templateUrl: './discounts-by-product.component.html',
})

export class DiscountsByProductComponent implements OnInit{
    ...
    ngOnInit() {
        this.discountService.getReportData('product', this.dateRangeSource).subscribe((discountData) => {
