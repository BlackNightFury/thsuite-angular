...
@Component({
  selector: 'app-discounts-by-employee',
  templateUrl: './discounts-by-employee.component.html'
})
export class DiscountsByEmployeeComponent implements OnInit {
    ...
    ngOnInit() {
        this.discountService.getReportData('employee', this.dateRangeSource).subscribe((discountData) => {
