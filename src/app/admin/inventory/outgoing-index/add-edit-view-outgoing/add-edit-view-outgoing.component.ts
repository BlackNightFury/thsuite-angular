...
@Component({
    ...
    templateUrl: './add-edit-view-outgoing.component.html',
    animations: [
      trigger('leave', [
...
export class AddEditViewOutgoingComponent extends AddEditViewObjectComponent<ITransfer> implements OnInit {
    ...
    cancel() {
        if (this.animationStatus === 'active') {
            this.transferService.cancelEdit('outgoing');
        }
    }
}
